...
using Moq;
using Standardly.Core.Models.Services.Coordinations.TemplateGenerations;
...
namespace Standardly.Core.Tests.Unit.Services.Orchestrations.TemplateGenerations
{
    public partial class TemplateGenerationCoordinationServiceTests
    {
        ...
        public TemplateGenerationCoordinationServiceTests()
        {
            ...
            templateGenerationOrchestrationService = new TemplateGenerationCoordinationService(
