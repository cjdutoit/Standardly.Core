    ...
    public partial class TemplateGenerationCoordinationServiceTests
    {
        ...
        public async Task ShouldThrowValidationExceptionWhenIfTemplateIsNullAsync()
        {
            ...
            var nullTemplateGenerationOrchestrationException =
                new NullTemplateGenerationCoordinationException();

            var expectedTemplateGenerationOrchestrationValidationException =
                new TemplateGenerationCoordinationValidationException(
            ...
            TemplateGenerationCoordinationValidationException actualException =
                await Assert.ThrowsAsync<TemplateGenerationCoordinationValidationException>(
