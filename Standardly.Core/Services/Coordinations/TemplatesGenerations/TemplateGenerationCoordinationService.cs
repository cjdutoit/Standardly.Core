...
using Task = Standardly.Core.Models.Services.Foundations.Templates.Tasks.Task;

namespace Standardly.Core.Services.Orchestrations.TemplatesGenerations
{
    public partial class TemplateGenerationCoordinationService : ITemplateGenerationCoordinationService
    {
        ...
        public TemplateGenerationCoordinationService(
        ...
        private async ValueTask PerformActionsAsync(
            ...
            TemplateGenerationInfo templateGenerationInfo)
        {
            foreach (Models.Services.Foundations.Templates.Tasks.Actions.Action action in task.Actions)
            {
                this.LogMessage(
                    DateTimeOffset.UtcNow,
        ...
        private Task RemoveTaskIfNotrequired(
            Task task)
        {
        ...
        private List<Models.Services.Foundations.Templates.Tasks.Actions.Action> RemoveActionIfNotRequired(
            List<Models.Services.Foundations.Templates.Tasks.Actions.Action> actions)
        {
            List<Models.Services.Foundations.Templates.Tasks.Actions.Action> actionsToRemove =
                new List<Models.Services.Foundations.Templates.Tasks.Actions.Action>();

            actions.ForEach(action =>
            {
                foreach (File file in action.Files.ToList())
                {
